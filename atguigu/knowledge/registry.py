from atguigu.knowledge.providers import KnowledgeProvider, OrderAPIProvider, FAQProvider, RAGProvider
...
if __name__ == '__main__':
    registry = KnowledgeProviderRegistry([OrderAPIProvider(),FAQProvider(),RAGProvider()])
